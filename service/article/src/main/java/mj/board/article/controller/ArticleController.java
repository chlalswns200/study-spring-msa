package mj.board.article.controller;

import lombok.RequiredArgsConstructor;
import mj.board.article.entity.Article;
import mj.board.article.service.ArticleService;
...
public class ArticleController {
    ...
    @GetMapping("/v1/articles/infinite-scorll")
    public List<ArticleResponse> readAllInfiniteScorll(
            @RequestParam("boardId") Long boardId,
